...
| :-------------------- | :----------------- | :----- | :---------------- |
| Add a Dog ✔️           | /api/dogs          | POST   | the new Dog       |
| View list of Dogs ✔️   | /api/dogs          | GET    | array of Dogs     |
| View Dog details ✔️    | /api/dogs/{id}     | GET    | a Dog             |
| Update Dog ✔️          | /api/dogs/{id}     | PUT    | updated Dog       |
| Remove a Dog ✔️        | /api/dogs/{id}     | DELETE | deleted Dog       |
